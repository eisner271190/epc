...
abstract class $TopicCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, DateTime lastUsed});
}
...
class _$TopicCopyWithImpl<$Res, $Val extends Topic>
  ...
  @override
  $Res call({Object? name = null, Object? lastUsed = null}) {
    return _then(
      _value.copyWith(
            name: null == name
                ? _value.name
...
class _$TopicImpl implements _Topic {
  const _$TopicImpl({required this.name, required this.lastUsed});
  ...
  @override
  String toString() {
    return 'Topic(name: $name, lastUsed: $lastUsed)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, lastUsed);
