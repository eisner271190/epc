...
abstract class $AuthTokensCopyWith<$Res> {
  ...
  @useResult
  $Res call({String idToken, String accessToken, String? refreshToken});
}
...
class _$AuthTokensImpl implements _AuthTokens {
  ...
  @override
  String toString() {
    return 'AuthTokens(idToken: $idToken, accessToken: $accessToken, refreshToken: $refreshToken)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, idToken, accessToken, refreshToken);
